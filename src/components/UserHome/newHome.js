...
const TR = ({ investment, setShowDocs, showDocs, setTradeData }) => {
    ...
    return (
        <TableRow key={investment._id} className="investment-row">
            ...
            <TableCell align="center">
                <Button variant="contained" size="small" color="secondary" style={{ backgroundColor: "#F53C56", color: "#ffffff" }} onClick={() => setTradeData({ open: true, type: 'sell', deal: investment.deal, investment: investment })}>
                    sell
                </Button>
            </TableCell>
        </TableRow>
