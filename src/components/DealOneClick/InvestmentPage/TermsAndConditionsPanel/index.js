    ...
    <section className="TermsAndConditions">
      <div className="terms-container">
        ...
        <Box p={3}>
          ...
          <Typography>
            I have read and agree to the Portfolio Company’s investment agreement, which is attached to the SPV Documents and will be executed between the Portfolio Company and the SPV.
          </Typography>
          <Typography>
            The Manager and Administrative Manager reserve the right to reject any investment.
          </Typography>
          <Typography>
            I understand that I must do my own diligence, read the investment documents and ask any questions I think are relevant to my investment decision. Portfolio Company information may be incomplete and has not been verified. The Manager may not have done extensive due diligence on the Portfolio Company. Investing with notable investors doesn’t guarantee any level of diligence has been performed.
          </Typography>
          <Typography>
            I understand that the Manager and other investors may have access to material information regarding the company that has not been shared with me.
          </Typography>
          <Typography>
            I understand that my subscription amount is not guaranteed and the final investment amount accepted by the SPV may be less than my desired subscription amount.
          </Typography>
        </Box>
        <label>
          <Checkbox className="terms-checkbox" onChange={(e) => setCheckedTAT(e.target.checked)} />
