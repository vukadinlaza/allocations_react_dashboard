...
import { DealPageProvider } from '../../dashboard/FundManagerDashboard/sections/DealPage/DealPageContext';
import DealPageButtons from './DealPageButtons';
...
function DealLandingPageRedesign({ orgSlug, dealSlug, goToDeal, dealPageRedesign }) {
