    ...
    <section className="CryptoDisclosure">
      ...
      <Box className="content" p={3}>
        ...
        <p>
          ...
          Cryptocurrency shall be processed by a third party, Coinbase Global, Inc. (“Coinbase”) a
          publicly traded company located in, and organized under the laws of the United States.
          Coinbase is a separate legal entity and not affiliated with Allocations, Inc., through
          common ownership. Virtual currency is not legal tender, and is not backed by the
          government. Your Crypto Assets are not insured or guaranteed by the FDIC, Securities
          ...
          government order. In such instances, regardless of the reason we have blocked, canceled or
          reversed your transaction and regardless of the reason we have lifted or reversed that
          ...
          canceled or reversed. Legislative and regulatory changes or actions at the state, federal,
          or international level may adversely affect the use, transfer, exchange and value of
          virtual currency.
        </p>
      </Box>
    </section>
