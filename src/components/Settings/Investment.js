  ...
  return (
    <div className={classes.root}>
      <Paper square className={classes.titleContainer}>
        ...
        <Typography
          style={{ color: 'rgb(42,43,84,77%)' }}
        >{`Investment - ${investment._id}`}</Typography>
      ...
      <Paper square className={classes.userInformation}>
        <GridSection title="Investor Information" fields={fields.investor} item={investor} />
        <GridSection title="Deal Information" fields={fields.deal} item={deal} />
        <GridSection title="Investment Information" fields={fields.investment} item={investment} />
        <GridSection title="Submission Data" fields={fields.submissionData} item={submissionData} />
