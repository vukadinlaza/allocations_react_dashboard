    ...
    <section className="W8BENE">
      ...
      <form className="form">
          ...
          <FormControl className="checkbox">
            <label className="form-label">
              <Checkbox
                ...
                name="showPart3"
              />
              If you entered disregarded entity, partnership, simple trust, or grantor trust above, is the entity a
              hybrid making a treaty claim?
            </label>
          </FormControl>
        )}
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <TextField className="resident-of" variant="outlined" name="14a_resident_of" onChange={handleChange} />
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <b>14b.&nbsp;</b>
                The beneficial owner derives the item (or items) of income for which the treaty benefits are claimed,
                and, if applicable, meets the requirements of the treaty provision dealing with limitation on benefits.
                The following are types of limitation on benefits provisions that may be included in an applicable tax
                treaty (check only one; see instructions):
              </label>
            </FormControl>
            ...
            {formData['14b'] && (
              <FormControl className="form-field">
                ...
                >
                  ...
                  <MenuItem value="14b_tax_exempt_pension">Tax exempt pension trust or pension fund</MenuItem>
                  <MenuItem value="14b_other_tax_exempt">Other tax exempt organization</MenuItem>
                  <MenuItem value="14b_publicly">Publicly traded corporation</MenuItem>
                  <MenuItem value="14b_subsidiary">Subsidiary of a publicly traded corporation</MenuItem>
                  <MenuItem value="14b_base_erosion">Company that meets the ownership and base erosion test</MenuItem>
                  <MenuItem value="14b_derivative_benefits">Company that meets the derivative benefits test</MenuItem>
                  ...
                  <MenuItem value="14b_other">Other (specify Article and paragraph):</MenuItem>
                </Select>
              </FormControl>
            )}
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <b>14c.&nbsp;</b>The beneficial owner is claiming treaty benefits for U.S source dividends received from
                a foreign corporation or interest from a U.S. trade or business of a foreign corporation and meets
                qualified resident status (see instructions).
              </label>
            </FormControl>

            <FormControl className="form-input">
              <label className="form-group-label">Special rates and conditions (if applicable, see instructions)</label>
              ...
              <label className="form-label">
                Explain the additional conditions in the Article the beneficial owner meets to be eligible for the rate
                of withholding:
                <TextField className="label-input" variant="outlined" />
              </label>
            </FormControl>
        ...
        <FormControl className="form-field chapter4Status">
          <label className="form-label">
            ...
            >
              ...
              <MenuItem value="5_excepted_nonfinancial_entity_liquidation">
              ...
              <MenuItem value="5_publicly_traded_nffe">
        ...
        {formData['5_nonfinancial_entity'] && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              <label className="form-label">
                <b>33&nbsp;</b>
                <Checkbox checked={formData['33']} onChange={handleCheckBox} name="33" />I certify that the entity
              ...
              <ul>
                ...
                <li className="terms">
                  During the past 5 years has not been engaged in business as a financial institution or acted as a
                  passive NFFE;
                </li>

                <li className="terms">
                  Is either liquidating or emerging from a reorganization or bankruptcy with the intent to continue or
                  recommence operations as a nonfinancial entity; <strong>and</strong>
                </li>
        ...
        {formData.chapter4Status === 'excepted_nonfinancial_start_up' && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Was formed on (or, in the case of a new line of business, the date of board resolution approving the
                  new line of business). Date must be less than 24 months prior to date of payment.
                  <TextField type="date" className="date-input" />
                </li>

                <li className="terms">
                  Is not yet operating a business and has no prior operating history or is investing capital in assets
                  with the intent to operate a new line of business other than that of a financial institution or
                  passive NFFE;
                </li>

                <li className="terms">
                  Is investing capital into assets with the intent to operate a business other than that of a financial
                  institution; <strong>and</strong>
                </li>

                <li className="terms">
                  Does not function (or hold itself out) as an investment fund, such as a private equity fund, venture
        ...
        {formData.chapter4Status === 'excepted_nonfinancial_group_entity' && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              <label className="form-label">
                <b>32&nbsp;</b>
                <Checkbox checked={formData.p3_c3} onChange={handleCheckBox} name="p3_c3" />I certify that the entity
                identified in Part I:
              </label>

              <ul>
                <li className="terms">
                  Is a holding company, treasury center, or captive finance company and substantially all of the
                  entity's activities are functions described in Regulations section 1.1471-5(e)(5)(i)(C) through (E);
                </li>

                <li className="terms">
                  Is not a depository or custodial institution (other than for members of the entity's expanded
                  affiliated group); <strong>and</strong>
                </li>

                <li className="terms">
                  Does not function (or hold itself out) as an investment fund, such as a private equity fund, venture
                  capital fund, leveraged buyout fund, or any investment vehicle with an investment strategy to acquire
                  or fund companies and then hold interests in those companies as capital assets for investment
                  purposes.
                </li>
              </ul>
            </FormControl>
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox-list">
              <label className="form-label">
                <b>43&nbsp;</b>
                <Checkbox checked={formData.p3_c3} onChange={handleCheckBox} name="p3_c3" />I certify that the entity
                identified in Part I is a direct reporting NFFE that is sponsored by the entity identified on line 42.
              </label>
            </FormControl>
          </FormGroup>
        )}
          ...
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  Each direct holder of an equity interest in the investment entity is an exempt beneficial owner
                  described in Regulations section 1.1471-6 or in an applicable Model 1 or Model 2 IGA;
                </li>

                <li className="terms">
                  Each direct holder of a debt interest in the investment entity is either a depository institution
                  (with respect to a loan made to such entity) or an exempt beneficial owner described in Regulations
                  section 1.1471-6 or an applicable Model 1 or Model 2 IGA.
                </li>

                <li className="terms">
                  Has provided an owner reporting statement that contains the name, address, TIN (if any), chapter 4
                  status, and a description of the type of documentation provided to the withholding agent for every
                  person that owns a debt interest constituting a financial account or direct equity interest in the
                  entity; <strong>and</strong>
                </li>

                <li className="terms">
                  Has provided documentation establishing that every owner of the entity is an entity described in
                  Regulations section 1.1471-6(b), (c), (d), (e), (f) and/or (g) without regard to whether such owners
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox-list">
              <label className="form-label">
                ...
                I certify that the entity identified in Part I is an international organization described <br /> in
                section 7701(a)(18).
              </label>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  Is recognized as an intergovernmental or supranational organization under a foreign law similar to the
                  International Organizations Immunities Act or that has in effect a headquarters agreement with a
                  foreign government;
                </li>
                <li className="terms">
                ...
                <li className="terms">
                  Is the beneficial owner of the payment and is not engaged in commercial financial activities of a type
                  engaged in by an insurance company, custodial institution, or depository institution with respect to
                  the payments, accounts, or obligations for which this form is submitted (except as permitted in
        ...
        {formData.chapter4Status === 'exempt_retirement_plans' && (
          <FormGroup className="form-group">
            <label className="form-group-label">Check box 29a, b, c, d, e, or f, whichever applies.</label>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">Is comprised primarily of foreign governments;</li>
                <li className="terms">
                  Is established in a country with which the United States has an income tax treaty in force (see Part
                  III if claiming treaty benefits);
                </li>
                <li className="terms">
                  Is operated principally to administer or provide pension or retirement benefits; <strong>and</strong>
                </li>
                <li className="terms">
                  Is entitled to treaty benefits on income that the fund derives from U.S. sources (or would be entitled
                  to benefits if it derived any such income) as a resident of the other country which satisfies any
                  applicable limitation on benefits requirement.
                </li>
              </ul>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  ...
                  thereof) to beneficiaries that are former employees of one or more employers in consideration for
                  services rendered;
                </li>

                <li className="terms">No single beneficiary has a right to more than 5% of the FFI's assets;</li>

                <li className="terms">
                  Is subject to government regulation and provides annual information reporting about its beneficiaries
                  to the relevant tax authorities in the country in which the fund is established or operated;{' '}
                  <strong>and</strong>
                  <p>
                    <strong>(i) &nbsp;</strong>
                    Is generally exempt from tax on investment income under the laws of the country in which it is
                    established or operates due to its status as a retirement or pension plan;
                  </p>
                  <p>
                    <strong>(ii) &nbsp;</strong>
                    Receives at least 50% of its total contributions from sponsoring employers (disregarding transfers
                    of assets from other plans described in this part, retirement and pension accounts described in an
                    applicable Model 1 or Model 2 IGA, other retirement funds described in an applicable Model 1 or
                    Model 2 IGA, or accounts described in Regulations section 1.1471-5(b)(2)(i)(A));
                  </p>
                  <p>
                    <strong>(iii) &nbsp;</strong>
                    Either does not permit or penalizes distributions or withdrawals made before the occurrence of
                    specified events related to retirement, disability, or death (except rollover distributions to
                    accounts described in Regulations section 1.1471-5(b)(2)(i)(A) (referring to retirement and pension
                    accounts), to retirement and pension accounts described in an applicable Model 1 or Model 2 IGA, or
                    to other retirement funds described in this part or in an applicable Model 1 or Model 2 IGA);
                    <strong>or</strong>
                  </p>
                  <p>
                    <strong>(iv) &nbsp;</strong>
                    Limits contributions by employees to the fund by reference to earned income of the employee or may
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">Has fewer than 50 participants;</li>
                ...
                <li className="terms">
                  Employee and employer contributions to the fund (disregarding transfers of assets from other plans
                  described in this part, retirement and pension accounts described in an applicable Model 1 or Model 2
                  IGA, or accounts described in Regulations section 1.1471-5(b)(2)(i)(A)) are limited by reference to
                  earned income and compensation of the employee, respectively;
                </li>

                <li className="terms">
                  Participants that are not residents of the country in which the fund is established or operated are
                  not entitled to more than 20% of the fund's assets; <strong>and</strong>
                </li>

                <li className="terms">
                  Is subject to government regulation and provides annual information reporting about its beneficiaries
                  to the relevant tax authorities in the country in which the fund is established or operates.
                </li>
              </ul>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              <label className="form-label">
                <b>29d&nbsp;</b>
                <Checkbox checked={formData.p3_c3} onChange={handleCheckBox} name="p3_c3" />I certify that the entity
                identified in Part I is formed pursuant to a pension plan that would meet the requirements of section
                401(a), other than the requirement that the plan be funded by a trust created or organized in the United
                States.
              </label>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              <label className="form-label">
                <b>29e&nbsp;</b>
                <Checkbox checked={formData.p3_c3} onChange={handleCheckBox} name="p3_c3" />I certify that the entity
                identified in Part I is established exclusively to earn income for the benefit of one or more retirement
                funds described in this part or in an applicable Model 1 or Model 2 IGA, or accounts described in
                Regulations section 1.1471-5(b)(2)(i)(A) (referring to retirement and pension accounts), or retirement
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Is established and sponsored by a foreign government, international organization, central bank of
                  issue, or government of a U.S. possession (each as defined in Regulations section 1.1471-6) or an
                  exempt beneficial owner described in an applicable Model 1 or Model 2 IGA to provide retirement,
                  disability, or death benefits to beneficiaries or participants that are current or former employees of
                  the sponsor (or persons designated by such employees); <strong>or</strong>
                </li>
                ...
                <li className="terms">
                  ...
                  issue, or government of a U.S. possession(each as defined in Regulations section 1.1471-6) or an
                  exempt beneficial owner described in an applicable Model 1 or Model 2 IGA to provide retirement,
                  disability, or death benefits to beneficiaries or participants that are not current or former
                  employees of such sponsor, but are in consideration of personal services performed for the sponsor.
                </li>
              </ul>
            </FormControl>
          </FormGroup>
        ...
        {formData.chapter4Status === 'active_nffe' && (
          <FormGroup className="form-group">
            <label className="form-group-label">
              <Checkbox checked={formData.p3_c3} onChange={handleCheckBox} name="p3_c3" />I certify that:
            </label>
            ...
            <ul>
              ...
              <li className="terms">
                Less than 50% of the assets held by such entity are assets that produce or are held for the production
                of passive income (calculated asa weighted average of the percentage of passive assets measured
                quarterly)
              </li>
            </ul>
          </FormGroup>
        ...
        {formData.chapter4Status === '501(c)' && (
          <FormGroup className="form-group">
            <label className="form-group-label">
              <Checkbox checked={formData['501c']} onChange={handleCheckBox} name="501c" />I certify that the entity
              identified in Part I is a 501(c) organization that:
            </label>

            <ul className="terms-list">
              <li className="terms">
                Has been issued a determination letter from the IRS that is currently in effect concluding that the
                payee is a section 501(c) organization that is dated
                <TextField className="date-input" type="date" />
                <b>or;</b>
              </li>

              <li className="terms">
                Has provided a copy of an opinion from U.S. counsel certifying that the payee is a section 501(c)
                organization (without regard to whether the payee is a foreign private foundation).
              </li>
            </ul>
          </FormGroup>
        )}
        ...
        {formData['4_nonprofit_organization'] && (
          <>
            ...
            <ul className="terms-list">
              <li className="terms">
                The entity is established and maintained in its country of residence exclusively for religious,
                charitable, scientific, artistic, cultural or educational purposes;
              </li>
              <li className="terms">The entity is exempt from income tax in its country of residence;</li>
              <li className="terms">
                The entity has no shareholders or members who have a proprietary or beneficial interest in its income or
                assets;
              </li>
              <li className="terms">
                Neither the applicable laws of the entity's country of residence nor the entity's formation documents
                permit any income or assets of the entity to be distributed to, or applied for the benefit of, a private
                person or noncharitable entity other than pursuant to the conduct of the entity's charitable activities
                or as payment of reasonable compensation for services rendered or payment representing the fair market
                value of property which the entity has purchased; <b>and</b>
              </li>
              <li className="terms">
                The applicable laws of the entity's country of residence or the entity's formation documents require
                that, upon the entity's liquidation or dissolution, all of its assets be distributed to an entity that
                is a foreign government, an integral part of a foreign government, a controlled entity of a foreign
                government, or another organization that is described in this part or escheats to the government of the
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li>
                  ...
                  including (name one securities exchange upon which the stock is regularly traded).
                </li>
              </ul>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  ...
                  <p>
                    <b>(iii)&nbsp;</b> Is not an insurance company (or the holding company of an insurance company) that
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <b>40a.&nbsp;</b>I certify that the entity identified in Part I is a foreign entity that is not a
                financial institution (other than an investment entity organized in a possession of the United States)
                and is not certifying its status as a publicly traded NFFE (or affiliate), excepted territory NFFE,
                direct reporting NFFE, or sponsored direct reporting NNFE.
              </label>
            </FormControl>
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <b>40b.&nbsp;</b>I further certify that the entity identified in Part I has no substantial U.S. owner
                (or, if applicable, no controlling U.S. persons); or
              </label>
            </FormControl>
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                <b>40c.&nbsp;</b>I further certify that the entity identified in Part I has provided the name, address,
                and TIN of each substantial U.S. owner (or, if applicable, contrilling U.S. person) of the NFFE in Part
                XXIX.
              </label>
            </FormControl>
          </FormGroup>
        ...
        {formData['40c'] && formData['5_passive_nffe'] && (
          <FormGroup className="form-group">
            ...
            <Button onClick={handleOwnerAdd} className="add-owner" variant="outlined">
              Add U.S Owner
            </Button>
          </FormGroup>
        )}
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                onChange={() => setDifferentMailingAddress((t) => !t)}
