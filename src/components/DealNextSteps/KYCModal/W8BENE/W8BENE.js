...
function W8BENE({ toggleOpen, createDoc }) {
  ...
  const [formData, setFormData] = useState({
    ...
    passive_nffe_owners: [{ id: 1, name: '', address: '', tin: '' }],
    '4_corporation': false,
  ...
  const handleSubmit = () => {
    ...
    formData.passive_nffe_owners.forEach((owner) => {
      delete owner.id;
    });
      ...
      <form className="form">
          ...
          <label className="form-label">
            ...
            <Autocomplete
              ...
              onChange={(event, newInputValue) =>
                handleCountryChange('organization_country')(event, newInputValue)
              }
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox">
              <label className="form-label">
                ...
                benefits are claimed, and, if applicable, meets the requirements of the treaty
        ...
        <FormControl className="form-field chapter4Status">
          <label className="form-label">
            ...
            >
              ...
              <MenuItem value="5_entity_wholly_owned">
                Entity wholly owned by exempt beneficial owners
              </MenuItem>
              <MenuItem value="5_excepted_nonfinancial_group_entity">
                Excepted nonfinancial group entity
              </MenuItem>
              <MenuItem value="5_excepted_nonfinancial_start_up">
              ...
              <MenuItem value="5_sponsored_direct_reporting_nffe">
                Sponsored direct reporting NFFE
              </MenuItem>
              <MenuItem value="5_not_financial_account">
        ...
        {formData['5_nonfinancial_entity'] && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Filed a plan of liquidation, filed a plan of reorganization, or filed for
                  bankruptcy on
                  <TextField />;
                </li>

                <li className="terms">
                  During the past 5 years has not been engaged in business as a financial
                  institution or acted as a passive NFFE;
                </li>

                <li className="terms">
                  Is either liquidating or emerging from a reorganization or bankruptcy with the
                  intent to continue or recommence operations as a nonfinancial entity;{' '}
                  <strong>and</strong>
                </li>

                <li className="terms">
                  Has, or will provide, documentary evidence such as a bankruptcy filing or other
                  public documentation that supports its claim if it remains in bankruptcy or
        ...
        {formData.chapter4Status === 'excepted_nonfinancial_start_up' && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Was formed on (or, in the case of a new line of business, the date of board
                  resolution approving the new line of business). Date must be less than 24 months
                  prior to date of payment.
                  <TextField type="date" className="date-input" />
                </li>

                <li className="terms">
                  Is not yet operating a business and has no prior operating history or is investing
                  capital in assets with the intent to operate a new line of business other than
                ...
                <li className="terms">
                  ...
                  that of a financial institution; <strong>and</strong>
                </li>

                <li className="terms">
                  Does not function (or hold itself out) as an investment fund, such as a private
        ...
        {formData.chapter4Status === 'excepted_nonfinancial_group_entity' && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Is a holding company, treasury center, or captive finance company and
                  substantially all of the entity's activities are functions described in
                  Regulations section 1.1471-5(e)(5)(i)(C) through (E);
                </li>

                <li className="terms">
                  Is not a depository or custodial institution (other than for members of the
                  entity's expanded affiliated group); <strong>and</strong>
                </li>

                <li className="terms">
                  Does not function (or hold itself out) as an investment fund, such as a private
                  equity fund, venture capital fund, leveraged buyout fund, or any investment
                  vehicle with an investment strategy to acquire or fund companies and then hold
          ...
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  Each direct holder of an equity interest in the investment entity is an exempt
                  beneficial owner described in Regulations section 1.1471-6 or in an applicable
                  Model 1 or Model 2 IGA;
                </li>

                <li className="terms">
                  Each direct holder of a debt interest in the investment entity is either a
                  depository institution (with respect to a loan made to such entity) or an exempt
                  beneficial owner described in Regulations section 1.1471-6 or an applicable Model
                  1 or Model 2 IGA.
                </li>

                <li className="terms">
                  Has provided an owner reporting statement that contains the name, address, TIN (if
                  any), chapter 4 status, and a description of the type of documentation provided to
                  the withholding agent for every person that owns a debt interest constituting a
                  financial account or direct equity interest in the entity; <strong>and</strong>
                </li>

                <li className="terms">
                  Has provided documentation establishing that every owner of the entity is an
                  entity described in Regulations section 1.1471-6(b), (c), (d), (e), (f) and/or (g)
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  Is recognized as an intergovernmental or supranational organization under a
                  foreign law similar to the International Organizations Immunities Act or that has
                  in effect a headquarters agreement with a foreign government;
                </li>
                <li className="terms">
                ...
                <li className="terms">
                  Is the beneficial owner of the payment and is not engaged in commercial financial
                  activities of a type engaged in by an insurance company, custodial institution, or
                  depository institution with respect to the payments, accounts, or obligations for
                  which this form is submitted (except as permitted in Regulations section
                  1.1471-6(h)(2)).
                </li>
              </ul>
            </FormControl>
          ...
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">Is comprised primarily of foreign governments;</li>
                <li className="terms">
                  Is established in a country with which the United States has an income tax treaty
                  in force (see Part III if claiming treaty benefits);
                </li>
                <li className="terms">
                ...
                <li className="terms">
                  Is entitled to treaty benefits on income that the fund derives from U.S. sources
                  (or would be entitled to benefits if it derived any such income) as a resident of
                  the other country which satisfies any applicable limitation on benefits
                  requirement.
                </li>
              </ul>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  Is organized for the provision of retirement, disability, or death benefits (or
                  any combination thereof) to beneficiaries that are former employees of one or more
                ...
                <li className="terms">
                  Is subject to government regulation and provides annual information reporting
                  about its beneficiaries to the relevant tax authorities in the country in which
                  the fund is established or operated; <strong>and</strong>
                  <p>
                    <strong>(i) &nbsp;</strong>
                    Is generally exempt from tax on investment income under the laws of the country
                    in which it is established or operates due to its status as a retirement or
                    pension plan;
                  </p>
                  <p>
                    <strong>(ii) &nbsp;</strong>
                    Receives at least 50% of its total contributions from sponsoring employers
                    (disregarding transfers of assets from other plans described in this part,
                    retirement and pension accounts described in an applicable Model 1 or Model 2
                    IGA, other retirement funds described in an applicable Model 1 or Model 2 IGA,
                    or accounts described in Regulations section 1.1471-5(b)(2)(i)(A));
                  </p>
                  <p>
                    <strong>(iii) &nbsp;</strong>
                    Either does not permit or penalizes distributions or withdrawals made before the
                    occurrence of specified events related to retirement, disability, or death
                    (except rollover distributions to accounts described in Regulations section
                    1.1471-5(b)(2)(i)(A) (referring to retirement and pension accounts), to
                    retirement and pension accounts described in an applicable Model 1 or Model 2
                    IGA, or to other retirement funds described in this part or in an applicable
                    Model 1 or Model 2 IGA);
                    <strong>or</strong>
                  </p>
                  <p>
                    <strong>(iv) &nbsp;</strong>
                    Limits contributions by employees to the fund by reference to earned income of
                    the employee or may not exceed $50,000 annually.
                  </p>
                </li>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  Is sponsored by one or more employers each of which is not an investment entity or
                  passive NFFE;
                </li>

                <li className="terms">
                  Employee and employer contributions to the fund (disregarding transfers of assets
                  from other plans described in this part, retirement and pension accounts described
                  in an applicable Model 1 or Model 2 IGA, or accounts described in Regulations
                  section 1.1471-5(b)(2)(i)(A)) are limited by reference to earned income and
                  compensation of the employee, respectively;
                </li>

                <li className="terms">
                  Participants that are not residents of the country in which the fund is
                  established or operated are not entitled to more than 20% of the fund's assets;{' '}
                  <strong>and</strong>
                </li>
            ...
            <FormControl className="checkbox-list">
              <label className="form-label">
                ...
                income for the benefit of one or more retirement funds described in this part or in
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  ...
                  central bank of issue, or government of a U.S. possession (each as defined in
                  Regulations section 1.1471-6) or an exempt beneficial owner described in an
                  applicable Model 1 or Model 2 IGA to provide retirement, disability, or death
                  benefits to beneficiaries or participants that are current or former employees of
                ...
                <li className="terms">
                  ...
                  Regulations section 1.1471-6) or an exempt beneficial owner described in an
                  applicable Model 1 or Model 2 IGA to provide retirement, disability, or death
                  benefits to beneficiaries or participants that are not current or former employees
                  of such sponsor, but are in consideration of personal services performed for the
                  sponsor.
                </li>
              </ul>
            </FormControl>
        ...
        {formData.chapter4Status === 'active_nffe' && (
          <FormGroup className="form-group">
            ...
            <ul>
              <li className="terms">
                The entity identified in Part 1 is a foreign entity that is not a finanical
                institution;
              </li>

              <li className="terms">
                Less than 50% of such entity's gross income for the preceding calendar year is
                passive income; <b>and</b>
              </li>

              <li className="terms">
                Less than 50% of the assets held by such entity are assets that produce or are held
                for the production of passive income (calculated asa weighted average of the
                percentage of passive assets measured quarterly)
              </li>
            </ul>
          </FormGroup>
        )}
        ...
        {formData.chapter4Status === '501(c)' && (
          <FormGroup className="form-group">
            ...
            <ul className="terms-list">
              <li className="terms">
                Has been issued a determination letter from the IRS that is currently in effect
                concluding that the payee is a section 501(c) organization that is dated
                <TextField className="date-input" type="date" />
                <b>or;</b>
              </li>

              <li className="terms">
                Has provided a copy of an opinion from U.S. counsel certifying that the payee is a
                section 501(c) organization (without regard to whether the payee is a foreign
                private foundation).
              </li>
            </ul>
          </FormGroup>
        ...
        {formData['4_nonprofit_organization'] && (
          <>
            ...
            <ul className="terms-list">
              <li className="terms">
                The entity is established and maintained in its country of residence exclusively for
              ...
              <li className="terms">
                The entity has no shareholders or members who have a proprietary or beneficial
                interest in its income or assets;
              </li>
              <li className="terms">
                Neither the applicable laws of the entity's country of residence nor the entity's
                formation documents permit any income or assets of the entity to be distributed to,
                or applied for the benefit of, a private person or noncharitable entity other than
                pursuant to the conduct of the entity's charitable activities or as payment of
                reasonable compensation for services rendered or payment representing the fair
                market value of property which the entity has purchased; <b>and</b>
              </li>
              <li className="terms">
                The applicable laws of the entity's country of residence or the entity's formation
                documents require that, upon the entity's liquidation or dissolution, all of its
                assets be distributed to an entity that is a foreign government, an integral part of
                a foreign government, a controlled entity of a foreign government, or another
                organization that is described in this part or escheats to the government of the
        ...
        {formData['4_publicly_traded_nffe'] && (
          <FormGroup className="form-group">
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li>
                  The entity identified in Part I is a foreign corporation that is not a financial
                  institution; and
                </li>
                <li>
                  The stock of such corporation is regularly traded on one or more established
                  securities markets, including (name one securities exchange upon which the stock
                  is regularly traded).
                </li>
              </ul>
            </FormControl>
            ...
            <FormControl className="checkbox-list">
              ...
              <ul>
                ...
                <li className="terms">
                  The entity identified in Part I is a member of the same expanded affiliated group
                  as an entity the stock of which is regularly traded on an established securities
                  market;
                </li>
                <li className="terms">
                  The name of the entity, the stock of which is regularly traded on an established
                  securities market, is <TextField /> ; <b>and</b>
                </li>
                <li className="terms">
        ...
        {formData['5_excepted_territory_nffe'] && (
          <FormGroup className="form-group">
            <FormControl className="checkbox-list">
              ...
              <ul>
                <li className="terms">
                  The entity identified in Part I is an entity that is organized in a possession of
                  the United States;
                </li>
                ...
                <li className="terms">
                  ...
                  <p>
                    <b>(i)&nbsp;</b> Does not accept deposits in the ordinary course of a banking or
                    similar business;
                  </p>
                  <p>
                    <b>(ii)&nbsp;</b>
                    Does not hold, as a substantial portion of its business, financial assets for
                    the account of others; or
                  </p>
                  <p>
                    <b>(iii)&nbsp;</b> Is not an insurance company (or the holding company of an
                    insurance company) that issues or is obligated to make payments with respect to
                    a financial account; and
                  </p>
                </li>

                <li className="terms">
                  All of the owners of the entity identified in Part I are bona fide residents of
                  the possession in which the NFFE is organized or incorporated.
                </li>
              </ul>
            </FormControl>
          </FormGroup>
            ...
            <FormControl className="country" required variant="outlined">
              <label className="form-label">
                ...
                <Autocomplete
                  ...
                  onChange={(event, newInputValue) =>
                    handleCountryChange('residence_country')(event, newInputValue)
                  }
