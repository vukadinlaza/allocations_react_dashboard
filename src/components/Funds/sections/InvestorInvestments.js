...
const InvestorInvestments = ({ classes, history }) => {
  ...
  const handleSearch = (e) => {
	...
	dataCopy.investor.investments = dataCopy.investor.investments
																	.filter(inv =>  `${inv.deal.company_name} ${inv.status}`
																									.toLowerCase()
  ...
  return (
		<div>
			...
			<Typography className={classes.back} onClick={() => history.goBack()}><NavigateBeforeIcon/> Back to Investors</Typography>
