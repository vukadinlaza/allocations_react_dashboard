...
export const dealSteps = {
  buildSteps: [
    ...
    },
    {
      ...
      tooltip: 'Uploaded investment documents for Portfolio Company. This is internally reviewed by the Allocations compliance team to determine whether Allocations can power the deal.',
      processStreetTask: ['review build submission']
    },
    {
      value: 'Portfolio Company Deck Uploaded',
      tooltip: 'Uploaded Deck for Portfolio Company. This is internally reviewed by the Allocations compliance team to determine whether Allocations can power the deal.',
      processStreetTask: ['review build submission']
    },
  ],
  preOnboardingSteps: [
    ...
    },
    {
      ...
      processStreetTask: ['frb confirm wire instructions', 'mercury bank confirm wire instructions']
    },
    {
  ...
  onboardingSteps: [
    {
      ...
      tooltip: 'This is the list of investors and proposed investment amounts provided by the fund manager in Google Sheets',
