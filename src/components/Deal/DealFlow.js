...
function KYCDocusign({ deal, investor, status, hasKyc }) {
  ...
  if (!link?.redirectUrl || hasKyc) return <DocusignKYCEmbeddedForm hasKyc={hasKyc} setLink={setLink} deal_slug={deal.deal_slug} org={deal.organization} company_name={deal.company_name} dealType={deal.dealParams.dealType} />
