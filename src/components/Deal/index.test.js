      ...
      data: {
        investor: {
          ...
          invitedDeal: {
            ...
            onboarding_link: "https://na3.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=a24bcfd2-755c-4ce7-8d3d-bac1b2eccac0&env=na3-eu1&acct=97ababd0-ed90-438a-a2c7-7162a7aa3d64",
            status: "onboarding",
            memo: "long deal description",
            documents: [
              {link: "https://google.com", path: "/"}
            ],
            investment: {
