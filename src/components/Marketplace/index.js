...
const deals = [
  ...
  },
  {
    ...
    name: 'Factmata',
    tagline: 'Natural language AI to help deal with the risks of online content',
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/factmata.png',
    est_personal_inv: 'TBD',
    highlight_2: '~£190 ARR, Raising $500k first equity round at 4m pre-money valuation',
    highlight_3: 'Their goal is to recapitalise the business and prepare for Series A',
    pledged: '$2,000',
    deal_lead: 'Giacomo Marriotti',
    closeDate: '11/20/2020',
    round: 'Bridge to A',
  },
  {
    color: randomColor({
