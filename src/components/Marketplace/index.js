...
const deals = [
  ...
  {
    color: randomColor({ luminosity: 'bright', hue: 'blue' }),
    to: 'https://docs.google.com/spreadsheets/d/11Etcnt6-jZ6OPg_xmm47Wpt1O2WGbw676EcECHZFfbw/edit#gid=0',
    name: 'Allocations',
    tagline: "The world's fastest growing fund administration platform",
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/allocations.png',
    est_personal_inv: '$100,000',
    highlight_1: 'Allocations is the easiest place to set up and manage SPVs and funds',
    highlight_2: 'Platform built by and for successful angel investors',
    highlight_3: 'Strong sales pipeline and ambitious roadmap',
    pledged: '$125,000',
    deal_lead: 'Kingsley Advani',
    closeDate: '11/30/2020',
    round: 'Seed',
    coinvestors: 'Joshua Browder, Ryan Kriser, Kingsley Advani, Kyle Wang, Winslow Strong',
  },
  {
    color: randomColor({ luminosity: 'bright', hue: 'blue' }),
    to: 'https://docs.google.com/spreadsheets/d/1usmSxSEX_W3UDr8Gvlgtq9QIfeq146JQBlWjO6244QM/edit#gid=0',
    name: 'Veamly',
    tagline: 'Developer first unified workplace',
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/veamly.png',
    est_personal_inv: 'TBD',
    highlight_1: 'Pipeline of 1200+ people and companies like Google, Twitter, Workday, Credit Karma',
    highlight_2: 'Palantir is a design partner',
    highlight_3:
      'Have developed a proprietary prioritization engine to reduce productivity loss from context switching',
    pledged: '$0',
    deal_lead: 'Ariana Thacker',
    closeDate: '11/30/2020',
    round: 'Seed',
    coinvestors: 'F&F, angels and accelerators',
  },
  {
    color: randomColor({ luminosity: 'bright', hue: 'blue' }),
    to: 'https://docs.google.com/spreadsheets/u/2/d/1G9INEmCGEoWuEcLpg1Yd9BBYBgouzo_3RogHUzU08Lo/edit#gid=0',
    name: 'OthersideAI',
    tagline: 'The most advanced artificial intelligence productivity tool for emails.',
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/otherside-ai.png',
    est_personal_inv: 'TBD',
    highlight_1:
      'Productivity tools of the future, utilizing the most advanced artificial intelligence technology in existence.',
    highlight_2:
      "Otherside generates full-length emails in the writer's personal style by simply typing an outline of key points",
    highlight_3: ' Seed round - 12.8m pre-money valuation',
    pledged: '$0',
    deal_lead: 'Jai Malik',
    closeDate: '11/15/2020',
    round: 'Seed',
    coinvestors: 'Chapter One Ventures, Hustle Fund',
  },
  {
    color: randomColor({ luminosity: 'bright', hue: 'blue' }),
    to: 'https://docs.google.com/spreadsheets/u/2/d/1PIABIcOxU3vMvAjSG8r6-CNrJPGiYLL6XCgPHZ5eM3M/edit#gid=0',
    name: 'Argo Health',
    tagline: 'Remote-first psychedelic therapy, starting with ketamine',
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/argo-health.png',
    est_personal_inv: 'TBD',
    highlight_1: 'Enhancing psychological programs with ketamine and other psychedelics planned in the future',
    highlight_2: 'Therapists have deep experience working with psychedelic medicine',
    highlight_3: '$5M cap pre-seed round',
    pledged: '$0',
    deal_lead: 'Milan Griffes',
    closeDate: '11/15/2020',
    round: 'Pre-Seed',
    coinvestors: 'Adam Wiggins, Jeff Atwood',
  },
  {
    color: randomColor({ luminosity: 'bright', hue: 'blue' }),
    to: 'https://docs.google.com/spreadsheets/u/2/d/1YAKnc1qt17egPyxBPnzMbFBmFIt0AcKW4brhjYHlztQ/edit#gid=0',
    name: 'Greyscale AI',
    tagline: 'Next generation package inspection',
    logo: 'https://allocations-public.s3.us-east-2.amazonaws.com/marketplace/greyscale_ai.png',
    est_personal_inv: 'TBD',
    highlight_1: 'X-ray scanning solution for identifying foreign materials in food packages and breaks in food seals',
    highlight_2:
      'Greyscale’s cloud-based solution scans packages on the production line and instantly identifies any issues',
    highlight_3: 'The business model is a one-time fee for the hardware and an annual SaaS fee for the software',
    pledged: '$0',
    deal_lead: 'Ajay Sharma',
    closeDate: '11/15/2020',
    round: 'Seed',
