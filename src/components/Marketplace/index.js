...
export default function Marketplace() {
  ...
  const deals = [
    ...
    },
    {
      ...
      name: 'ArcType',
      tagline: 'The easiest and most intuitive SQL client for developers and teams',
    ...
    },
    {
      ...
      highlight_1:
        'Company focused on environmentally friendly alternatives to the traditional production of meat and plant-based sources of nutrition',
